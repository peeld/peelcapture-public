...
class PeelRecordDialog(SimpleDeviceWidget):
    def __init__(self, settings):
        super().__init__(settings, "KiPro", has_host=True, has_port=True,
                         has_broadcast=False, has_listen_ip=False, has_listen_port=False)


class PeelRecord(PeelDeviceBase):

    def __init__(self, name, host=None, port=None, listen_ip=None, listen_port=None):
        super(PeelRecord, self).__init__(name)
        self.host = host
        self.port = port
